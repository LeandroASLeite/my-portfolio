    ...
    return (
        ...
        <div class="text-gray-600 body-font mt-16">
            <div class="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                ...
                <div class="animate-fade-right lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
                ...
                <div class="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
                    <img class="object-cover object-center rounded-full animate-fade-left" alt="hero" src={HomeImage}></img>
                </div>
            </div>
